...
(function() {
  ...
  DrupalCon.ui.createDayWindow = function(tabGroup) {
    ...
    var data = [
      {title:'Monday, March 7', hasChild:true, color:'#000', backgroundColor:'#fff', selectedBackgroundColor:'#0779BE', start_date:'2011-03-07T00:00:00', end_date:'2011-03-08T00:00:00'},
      {title:'Tuesday, March 8', hasChild:true, color:'#000', backgroundColor:'#fff', selectedBackgroundColor:'#0779BE', start_date:'2011-03-08T00:00:00', end_date:'2011-03-09T00:00:00'},
      {title:'Wednesday, March 9', hasChild:true, color:'#000', backgroundColor:'#fff', selectedBackgroundColor:'#0779BE', start_date:'2011-03-09T00:00:00', end_date:'2011-03-10T00:00:00'},
      {title:'Thursday, March 10', hasChild:true, color:'#000', backgroundColor:'#fff', selectedBackgroundColor:'#0779BE', start_date:'2011-03-10T00:00:00', end_date:'2011-03-11T00:00:00'},
      {title:'Friday, March 11', hasChild:true, color:'#000', backgroundColor:'#fff', selectedBackgroundColor:'#0779BE', start_date:'2011-03-11T00:00:00', end_date:'2011-03-12T00:00:00'}
    ];
